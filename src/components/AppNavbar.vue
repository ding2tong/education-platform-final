      ...
      <div class="nav-menu-wrapper">
        <div class="nav-menu">
          ...
          <router-link to="/dashboard" class="nav-link" v-if="authStore.isLoggedIn"
            >學習進度</router-link
          >
          <router-link to="/admin" class="nav-link" v-if="authStore.canManageCourses">管理後台</router-link>
          <router-link to="/admin/help" class="nav-link" v-if="authStore.canManageCourses">說明文件</router-link>
        </div>
